...
const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (result.isLoggedIn) setIsLogged(true)
    ...
    return (
        <div className="flex justify-center items-center h-screen w-screen">
            <Link to='/signup' className="absolute right-1 top-1 p-3 bg-[#00d1b2] hover:bg-[#00b89c] text-white rounded-xl leading-[18.4px] text-base font-bold cursor-pointer transition-colors duration-300">Kayıt Ol</Link>
            <form onSubmit={handleSubmit} className="flex flex-col p-10 bg-[rgba(0,0,0,0.25)] rounded-xl max-w-md w-full shadow-2xl"  >
                ...
                <button type="submit" className="w-full p-3 bg-[#00d1b2] hover:bg-[#00b89c] text-white rounded-xl leading-[18.4px] text-base font-bold cursor-pointer transition-colors duration-300" >Giriş Yap</button>
            </form>
        </div>
    )
}
